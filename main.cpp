...
void parte_a(){
    ...
    Alojamiento* al2 = new Alojamiento("ALJ4789", "Todas las habitaciones con vista al mar", 100, f2, "Hotel Sea View", MediaPension, 15);
...
void parte_b(){
    ...
    TourGuiado* tg1 = new TourGuiado("TGO4657", "Plazas de Montevideo", 10, f3, "Paseos SA", lugares1);
    ...
    TourGuiado* tg2 = new TourGuiado("TGR3257", "Puntos emblematicos", 5, f4, "Recorre", lugares2);
...
void parte_c(){
    ...
    EventoCultural* ec1 = new EventoCultural("ECP1346", "Danza en el Solis", 10, f5, "Teatro Solis", true);
...
void parte_h(){
    ...
    if (vanesa != NULL) { 
        ...
        std::cout << "--- Experiencias de Vanesa Castro posteriores al 10/12/2023 ---" << std::endl;
